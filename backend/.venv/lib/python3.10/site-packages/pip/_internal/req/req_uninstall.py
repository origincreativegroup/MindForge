    ...
    def from_dist(cls, dist: Distribution) -> "UninstallPathSet":
        ...
        if (
            ...
            raise UninstallationError(
                f"Cannot uninstall {dist.project_name!r}. It is a distutils installed project "
            ...
            assert link_pointer == dist.location, (
                f"Egg-link {link_pointer} does not match installed location of {dist.project_name} "
                f"(at {dist.location})"
            )
