...
class DefaultDialect(Dialect):
    ...
    def _deliver_insertmanyvalues_batches(
        ...
        _composite_sentinel_proc: Sequence[_ResultProcessorType[Any] | None] = ()
...
class DefaultExecutionContext(ExecutionContext):
    ...
    result_column_struct: (
        tuple[list[ResultColumnsEntry], bool, bool, bool, bool] | None
    ) = None
    ...
    def _setup_ins_pk_from_implicit_returning(self, result, rows):
        ...
        return [
            getter(row, param)
            for row, param in zip(rows, compiled_params, strict=False)
        ]
