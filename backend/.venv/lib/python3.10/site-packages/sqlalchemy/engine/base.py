    ...
    def _exec_insertmany_context(
        ...
        for imv_batch in dialect._deliver_insertmanyvalues_batches(
            ...
            if self._echo:
                ...
                imv_stats = f""" {imv_batch.batchnum}/{imv_batch.total_batches} ({
                    "ordered" if imv_batch.rows_sorted else "unordered"
                }{"; batch not supported" if imv_batch.is_downgraded else ""})"""
