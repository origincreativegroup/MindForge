...
if True:  # zimports removes the tailing comments
    from typing import Annotated as Annotated  # 3.8
    from typing import Concatenate as Concatenate  # 3.10
    from typing import Final as Final  # 3.8
    from typing import Literal as Literal  # 3.8
    from typing import NotRequired as NotRequired  # 3.11
    from typing import Self as Self  # 3.11
    from typing import TypeAlias as TypeAlias  # 3.10
    from typing import TypeGuard as TypeGuard  # 3.10
    from typing import final as final  # 3.8
    from typing import get_args as get_args  # 3.10
    from typing import get_origin as get_origin  # 3.10
