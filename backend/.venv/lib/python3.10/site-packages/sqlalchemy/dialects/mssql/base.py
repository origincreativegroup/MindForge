...
class MSDDLCompiler(compiler.DDLCompiler):
    ...
    def visit_drop_column_comment(self, drop, **kw):
        ...
        return (
            "execute sp_dropextendedproperty 'MS_Description', 'schema', "
            f"{self.preparer.quote_schema(schema_name)}, 'table', {self.preparer.format_table(drop.element.table, use_schema=False)}, 'column', {self.preparer.format_column(drop.element)}"
        )
