...
class Table(DialectKWArgs, HasSchemaAttr, TableClause, inspection.Inspectable["Table"]):
    ...
    def tometadata(
        ...
        referred_schema_fn: Callable[
            [Table, str | None, ForeignKeyConstraint, str | None], str | None
        ]
        | None = None,
        name: str | None = None,
    ) -> Table:
            ...
            if existing_col is not self:
                if not allow_replacements:
                    raise exc.DuplicateColumnError(
                        ...
                        f"""'{self.key if conflicts_on == "key" else self.name}' """
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    @overload
    def _resolve_column(self, *, raiseerr: bool = ...) -> Column[Any] | None: ...

    def _resolve_column(self, *, raiseerr: bool = True) -> Column[Any] | None:
        _column: Column[Any]
...
class ColumnCollectionMixin:
    ...
    def __init__(
        ...
        *columns: _DDLColumnArgument,
        ...
        processed_expressions: list[ColumnElement[Any] | str] | None = (
            _gather_expressions
        )
    ...
    def _col_expressions(self, parent: Table | Column[Any]) -> list[Column[Any] | None]:
...
class CheckConstraint(ColumnCollectionConstraint):
    ...
    def _copy(self, *, target_table: Table | None = None, **kw: Any) -> CheckConstraint:
...
class MetaData(HasSchemaAttr):
    ...
    def __init__(
        ...
        if schema is not None and not isinstance(schema, str):
            raise exc.ArgumentError(
                f"expected schema argument to be a string, got {type(schema)}."
            )
    ...
    def _add_table(self, name: str, schema: str | None, table: Table) -> None:
        key = _get_table_key(name, schema)
        ...
        **dialect_kwargs: Any,
        ...
        with inspection.inspect(bind)._inspection_context() as insp:
            ...
            if only is None:
                load = [
                    name
                    for name, schname in zip(
                        available, available_w_schema, strict=False
                    )
...
class Computed(FetchedValue, SchemaItem):
    ...
    def _copy(self, *, target_table: Table | None = None, **kw: Any) -> Computed:
