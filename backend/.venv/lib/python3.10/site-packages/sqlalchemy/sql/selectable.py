...
class CTE(
    ...
    def union(self, *other: _SelectStatementForCompoundArgument) -> CTE:
        ...
        """
        assert is_select_statement(self.element), (
...
class Subquery(AliasedReturnsRows):
    ...
    @classmethod
    def _factory(cls, selectable: SelectBase, name: str | None = None) -> Subquery:
...
class ForUpdateArg(ClauseElement):
    ...
    @classmethod
    def _from_argument(cls, with_for_update: ForUpdateParameter) -> ForUpdateArg | None:
...
class GenerativeSelect(SelectBase, Generative):
    ...
    def order_by(
        self,
        __first: Literal[None, _NoArg.NO_ARG]
        | _ColumnExpressionOrStrLabelArgument[Any] = _NoArg.NO_ARG,
...
class SelectState(util.MemoizedSlots, CompileState):
    ...
    @util.preload_module("sqlalchemy.sql.util")
    def _join_place_explicit_left_side(self, left: FromClause) -> int | None:
        replace_from_obj_index: int | None = None
...
class Select(
    ...
    def _copy_internals(self, clone: _CloneCallableType = _clone, **kw: Any) -> None:
        ...
        add_froms = {f for f in new_froms.values() if isinstance(f, Join)}.difference(
            all_the_froms
...
class Exists(UnaryExpression[bool]):
    ...
    def __init__(
        self,
        __argument: _ColumnsClauseArgument[Any]
        | SelectBase
        | ScalarSelect[Any]
        | None = None,
    ):
