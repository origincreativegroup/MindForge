                ...
                (
                    {
                        c.key: value
                        for c, value in zip(
                            statement.table.c, parameter_set, strict=False
                        )
                    }
...
class UpdateBase(
    ...
    _return_defaults_columns: tuple[_ColumnsClauseElement, ...] | None = None
        ...
        **kwargs: Any,
        ...
        if args:
            ...
            if kwargs:
                ...
                # tuple values
                arg = {
                    c.key: value for c, value in zip(self.table.c, arg, strict=False)
                }
