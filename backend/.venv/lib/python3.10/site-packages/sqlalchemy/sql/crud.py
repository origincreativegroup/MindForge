...
_CrudParamElement = tuple[
    ...
    | None,  # bound parameter string or SQL expression to apply
    Iterable[str],
]
...
def _get_crud_params(
    ...
    **kw: Any,
    ...
    assert "accumulate_bind_names" not in kw, (
...
def _key_getters_for_crud_column(
    ...
    if dml.isupdate(compile_state) and compile_state._extra_froms:
        ...
        def _column_as_key(key: ColumnClause[Any] | str) -> str | tuple[str, str]:
