...
class PathRegistry(HasCacheKey):
    ...
    def pairs(
        self,
    ) -> Iterator[tuple[_InternalEntityType[Any], str | StrategizedProperty[Any]]]:
...
class RootRegistry(CreatesToken):
    ...
    def _getitem(self, entity: Any) -> TokenRegistry | AbstractEntityRegistry:
