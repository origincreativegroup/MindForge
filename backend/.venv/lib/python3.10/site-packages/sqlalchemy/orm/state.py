...
class InstanceState(interfaces.InspectionAttrInfo, Generic[_O]):
    ...
    committed_state: builtins.dict[str, Any]
    ...
    _last_known_values: builtins.dict[str, Any] | None = None
    ...
    callables: builtins.dict[str, Callable[[InstanceState[_O], PassiveFlag], Any]]
    ...
    @util.memoized_property
    def parents(self) -> builtins.dict[int, Literal[False] | InstanceState[Any]]:
        return {}

    @util.memoized_property
    def _pending_mutations(self) -> builtins.dict[str, PendingCollection]:
        return {}

    @util.memoized_property
    def _empty_collections(self) -> builtins.dict[str, _AdaptedCollectionProtocol]:
        return {}
    ...
    def __setstate__(self, state_dict: builtins.dict[str, Any]) -> None:
