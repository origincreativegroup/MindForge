...
class AliasedInsp(
    ...
    * ``polymorphic_on`` - an alternate column or SQL expression which
    ...
    def _adapt_element(self, expr: _ORMCOLEXPR, key: str | None = None) -> _ORMCOLEXPR:
...
class Bundle(
    ...
    def mapper(self) -> Mapper[Any] | None:
        mp: Mapper[Any] | None = self.exprs[0]._annotations.get("parentmapper", None)
        return mp

    @property
    def entity(self) -> _InternalEntityType[Any] | None:
        ie: _InternalEntityType[Any] | None = self.exprs[0]._annotations.get(
            "parententity", None
        )
        return ie
