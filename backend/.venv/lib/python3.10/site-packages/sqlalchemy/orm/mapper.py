...
class Mapper(
    ...
    def __init__(
        ...
        polymorphic_on: _ORMColumnExprArgument[Any]
        | str
        | MapperProperty[Any]
        | None = None,
    ...
    _validate_polymorphic_identity: (
        Callable[[Mapper[_O], InstanceState[_O], _InstanceDict], None] | None
    )
    ...
    with_polymorphic: (
        tuple[Literal["*"] | Sequence[Mapper[Any] | type[Any]], FromClause | None]
        | None
    )
